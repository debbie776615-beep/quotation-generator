...
c1, c2, c3 = st.columns(3)
sales_rep = c1.text_input("業務代表", DEFAULT_SALES["rep"])
sales_phone = c2.text_input("業務電話", DEFAULT_SALES["phone"])
sales_email = c3.text_input("業務Email", DEFAULT_SALES["email"])
